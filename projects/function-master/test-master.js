(function(){
  ...
  QUnit.test( "Our First Test", function( assert ) {//pased
  ...
  QUnit.test("Functions can access/modify variables in parent scope.", function(assert){//passed
    var outside_the_function = null;
    function yay(){
      var inside_the_function = "Functions can access/modify variables in parent scope.";
      outside_the_function = inside_the_function;
    }

    yay();

    assert.equal(outside_the_function, "Functions can access/modify variables in parent scope.");
  });
  ...
  QUnit.test("Functions don't have access to eachothers scope", function(assert){//passed
    function yay(){
  ...
  QUnit.test("Inner scope variables override outter scope variables.", function(assert){//passed
